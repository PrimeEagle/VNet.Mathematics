...
{
    public class HyperGeometricDistribution : RandomDistributionBase, IDiscreteRandomDistributionAlgorithm
    {
        ...
        public HyperGeometricDistribution(int numberOfItems, int numberOfSuccessStates, int numberOfDraws) : base()
        {
        ...
        public HyperGeometricDistribution(IRandomGenerationAlgorithm randomGenerator, int numberOfItems, int numberOfSuccessStates, int numberOfDraws)
        {
            _numberOfItems = numberOfItems;
            _numberOfSuccessStates = numberOfSuccessStates;
            _numberOfDraws = numberOfDraws;
