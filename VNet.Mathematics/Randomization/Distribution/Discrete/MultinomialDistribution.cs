...
{
    public class MultinomialDistribution : RandomDistributionBase, IDiscreteRandomDistributionAlgorithm
    {
        ...
        public MultinomialDistribution(double[] probabilities, int numberOfTrials) : base()
        {
            var sum = 0d;
        ...
        public MultinomialDistribution(IRandomGenerationAlgorithm randomGenerator, double[] probabilities, int numberOfTrials) : base(randomGenerator)
        {
            var sum = 0d;
            foreach (var p in probabilities)
            {
