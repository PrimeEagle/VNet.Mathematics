...
{
    public class Gaussian : RandomDistributionBase, IGaussianDistributionAlgorithm
    {
        ...
        public Gaussian(double mean, double standardDeviation) : base()
        {
        ...
        public Gaussian(IRandomGenerationAlgorithm randomGenerator, double mean, double standardDeviation) : base(randomGenerator)
        {
            if (mean < 0d) throw new ArgumentOutOfRangeException(nameof(mean), "Must be a positive number.");
            if (standardDeviation < 0d) throw new ArgumentOutOfRangeException(nameof(standardDeviation), "Must be a positive number.");
        ...
        public Gaussian(IRandomGenerationAlgorithm randomGenerator) : base(randomGenerator)
        {
        }
