...
{
    public class CauchyDistribution : RandomDistributionBase, IContinuousRandomDistributionAlgorithm
    {
        ...
        public CauchyDistribution(double location, double scale) : base()
        {
        ...
        public CauchyDistribution(IRandomGenerationAlgorithm randomGenerator, double location, double scale) : base(randomGenerator)
        {
            if (location < 0d) throw new ArgumentOutOfRangeException(nameof(location), "Must be a positive number.");
            if (scale < 0d) throw new ArgumentOutOfRangeException(nameof(scale), "Must be a positive number.");
