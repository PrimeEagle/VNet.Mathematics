...
public class MersenneTwisterMT19937 : RandomGenerationBase<ulong, ulong>
{
    ...
    public MersenneTwisterMT19937(IEnumerable<ulong> seeds) : base(seeds)
    {
        _state = new ulong[N];
        _index = N + 1;
        Initialize(Seeds[0]);
    ...
    public MersenneTwisterMT19937(IEnumerable<string> seeds) : base(seeds)
    {
        _state = new ulong[N];
        _index = N + 1;
        Initialize(Seeds[0]);
    ...
    public MersenneTwisterMT19937(IEnumerable<ulong> seeds, ulong minValue, ulong maxValue) : base(seeds, minValue, maxValue)
    {
        _state = new ulong[N];
        _index = N + 1;
        Initialize(Seeds[0]);
    ...
    public MersenneTwisterMT19937(IEnumerable<string> seeds, ulong minValue, ulong maxValue) : base(seeds, minValue, maxValue)
    {
        _state = new ulong[N];
        _index = N + 1;
        Initialize(Seeds[0]);
    ...
    public MersenneTwisterMT19937(ulong minValue, ulong maxValue) : base(minValue, maxValue)
    {
        _state = new ulong[N];
        _index = N + 1;
        Initialize(Seeds[0]);
