...
public class Cmwc : RandomGenerationBase<ulong, ulong>
{
    ...
    public Cmwc(IEnumerable<ulong> seeds) : base(seeds)
    {
        _state = new ulong[StateSize];
        _index = 0;
        Initialize(Seeds[0]);
    ...
    public Cmwc(IEnumerable<string> seeds) : base(seeds)
    {
        _state = new ulong[StateSize];
        _index = 0;
        Initialize(Seeds[0]);
    ...
    public Cmwc(IEnumerable<ulong> seeds, ulong minValue, ulong maxValue) : base(seeds, minValue, maxValue)
    {
        _state = new ulong[StateSize];
        _index = 0;
        Initialize(Seeds[0]);
    ...
    public Cmwc(IEnumerable<string> seeds, ulong minValue, ulong maxValue) : base(seeds, minValue, maxValue)
    {
        _state = new ulong[StateSize];
        _index = 0;
        Initialize(Seeds[0]);
    ...
    public Cmwc(ulong minValue, ulong maxValue) : base(minValue, maxValue)
    {
        _state = new ulong[StateSize];
        _index = 0;
        Initialize(Seeds[0]);
